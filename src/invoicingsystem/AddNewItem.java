...
public class AddNewItem extends javax.swing.JFrame {
    ...
    void addNewItem(){
     ...
     String query = "insert into inv_items (`itm_name`, `itm_code`,"
             + " `itm_type`, `itm_rate`, `itm_tax_perc`, `itm_com_id`)"
             + " values('"+jTextField1.getText()+"', '"+jTextField2.getText()+"', '"+jTextField3.getText()+"', '"+jTextField5.getText()+"', "
             + "'"+jTextField4.getText()+"', '"+ManageItems.comid+"')";
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Adding New Item"));
