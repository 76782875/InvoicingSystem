...
public class EditCompany extends javax.swing.JFrame {
    ...
    try {
          con.rs =  con.st.executeQuery("SELECT * from inv_company where com_id = "+Index.idget);
           
          jTextFieldname.setText(con.rs.getString("com_name"));
          jTextField2owner.setText(con.rs.getString("com_owner"));
          jTextField3address.setText(con.rs.getString("com_address"));
          jTextField4phone.setText(con.rs.getString("com_phone"));
          jTextField5type.setText(con.rs.getString("com_type"));
          jTextField6code.setText(con.rs.getInt("com_code")+"");
          jTextField7landline.setText(con.rs.getString("com_landline"));
    ...
    void updateCompanyDetail(){
     ...
     String query = "UPDATE inv_company SET "
             + "com_name= '"+jTextFieldname.getText()+"', "
             + "com_type= '"+jTextField5type.getText()+"',"
             + "com_address= '"+jTextField3address.getText()+"',"
             + "com_phone= '"+jTextField4phone.getText()+"',"
             + "com_code= '"+jTextField6code.getText()+"',"
             + "com_owner= '"+jTextField2owner.getText()+"',"
             + "com_landline= '"+jTextField7landline.getText()+"'"
             + "where com_id="+Index.idget+"";
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Edit Company"));
